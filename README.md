...
- Use Firebase Firestore as the database to store user profiles and Firebase Cloud Storage to store images.
...
- [ ] Implement key backend features:
    - [ ] Set up the Flask app and create the API endpoints, Firebase project, RabbitMQ, and other infrastructure.
    - [ ] Implement the Solver Processing Service for processing images and returning solutions.
